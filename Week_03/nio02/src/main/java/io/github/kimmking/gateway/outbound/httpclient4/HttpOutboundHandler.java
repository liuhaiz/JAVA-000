...
//            System.out.println(body.length);
            ...
            System.out.println("请求拦截添加的request的 header信息 =>"+requestHeaders.get(HttpRequestFilterHandler.SOME_PARAM));
            // 2. 把这个信息传递给前端的response中
            response.headers().set(HttpRequestFilterHandler.SOME_PARAM, requestHeaders.get(HttpRequestFilterHandler.SOME_PARAM));
