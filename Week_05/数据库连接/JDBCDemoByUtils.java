...
public class JDBCDemoByUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		//增加
		sqlStatement = "INSERT INTO student VALUES('50','TEST','CHINA')";
		System.out.println("插入执行结果:"+update(sta,sqlStatement));
		//更新
		sqlStatement = "UPDATE student SET name='liuxiaohai' WHERE studentNO = '50'";
		System.out.println("更新执行结果:"+update(sta,sqlStatement));
		//删除
		sqlStatement = "DELETE FROM student WHERE studentNO = '50'";
